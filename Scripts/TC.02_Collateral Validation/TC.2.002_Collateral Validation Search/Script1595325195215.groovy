...
WebUI.setText(findTestObject('TC.02_Collateral Validation/txtCustomerName'), 'Clinton')

WebUI.setText(findTestObject('TC.02_Collateral Validation/txtApplicationNumber'), '202007401LS00143')

WebUI.sendKeys(findTestObject('TC.02_Collateral Validation/txtApplicationNumber'), Keys.chord(Keys.TAB))

WebUI.setText(findTestObject('TC.02_Collateral Validation/txtApplicationDateFrom'), '01/07/2020')

WebUI.setText(findTestObject('TC.02_Collateral Validation/txtApplicationDateTo'), '30/07/2020')
