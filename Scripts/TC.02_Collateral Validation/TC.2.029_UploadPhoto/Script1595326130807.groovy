...
WebUI.click(findTestObject('TC.02_Collateral Validation/ddlBranchBooking'))

WebUI.click(findTestObject('TC.02_Collateral Validation/itemDdlBranchBooking_MEDAN'))

WebUI.click(findTestObject('TC.02_Collateral Validation/ddlProduct'))

WebUI.click(findTestObject('TC.02_Collateral Validation/itemDdlProduct_NDF Car'))

WebUI.setText(findTestObject('TC.02_Collateral Validation/txtCustomerName'), 'Gogon')

not_run: WebUI.setText(findTestObject('TC.02_Collateral Validation/txtApplicationNumber'), '202007401LS00143')

not_run: WebUI.sendKeys(findTestObject('TC.02_Collateral Validation/txtApplicationNumber'), Keys.chord(Keys.TAB))

not_run: WebUI.setText(findTestObject('TC.02_Collateral Validation/txtApplicationDateFrom'), '01/07/2020')

not_run: WebUI.setText(findTestObject('TC.02_Collateral Validation/txtApplicationDateTo'), '30/07/2020')

not_run: WebUI.setText(findTestObject('TC.02_Collateral Validation/txtApprovalDateFrom'), '01/07/2020')

not_run: WebUI.setText(findTestObject('TC.02_Collateral Validation/txtApprovalDateTo'), '30/07/2020')
...
WebUI.click(findTestObject('TC.02_Collateral Validation/UploadPhoto/span_Found_no rangka'))

WebUI.click(findTestObject('TC.02_Collateral Validation/UploadPhoto/btnUpload'))
...
WebUI.setText(findTestObject('TC.02_Collateral Validation/UploadPhoto/txtReceiveBy'), 'Iwan')

WebUI.click(findTestObject('TC.02_Collateral Validation/UploadPhoto/divUploadDocument'))

CustomKeywords.'rendi.uploadNativePopUpWindow.uploadFile'(findTestObject('TC.02_Collateral Validation/UploadPhoto/divUploadDocument'), 
    GlobalVariable.filePath + '\\fotodenganrumah.jpg')

WebUI.delay(5)

WebUI.click(findTestObject('TC.02_Collateral Validation/UploadPhoto/btnSave'))
