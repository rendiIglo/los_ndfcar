...
WebUI.setText(findTestObject('Login/input_Username_UserName'), 'Budi')
...
WebUI.click(findTestObject('TC.04 Credit Analyst/menu Credit Analyst'))
...
WebUI.click(findTestObject('TC.04 Credit Analyst/select item branch booking'))

WebUI.click(findTestObject('TC.04 Credit Analyst/pilih dropdown medan'))

WebUI.setText(findTestObject('TC.04 Credit Analyst/input Application Date From From'), '19-Mei-2020')

WebUI.setText(findTestObject('TC.04 Credit Analyst/input Application Date From To'), '19-Mei-2020')

WebUI.setText(findTestObject('TC.04 Credit Analyst/input application number'), '202005401LS00042')

WebUI.setText(findTestObject('TC.04 Credit Analyst/input customer name'), 'Dodi')

WebUI.click(findTestObject('TC.04 Credit Analyst/button search'))
