...
WebUI.click(findTestObject('TC.04 Credit Analyst/pilih grid credit analyst'))

WebUI.click(findTestObject('TC.04 Credit Analyst/button process'))
...
WebUI.click(findTestObject('TC.04 Credit Analyst/button back after detail'))
