...
WebUI.click(findTestObject('TC.05_Collateral Appraisal/grid data collateral appraisal'))
...
WebUI.click(findTestObject('TC.05_Collateral Appraisal/asset photos update document button delete'))
