...
WebUI.setText(findTestObject('TC.05_Collateral Appraisal/input search'), '202007401LS00088')
...
WebUI.click(findTestObject('TC.05_Collateral Appraisal/grid exterior mobil'))
...
WebUI.click(findTestObject('TC.05_Collateral Appraisal/grid interior mobil'))
...
WebUI.click(findTestObject('TC.05_Collateral Appraisal/pilihan dropdown Interior Tidak Lengkap'))
...
WebUI.click(findTestObject('TC.05_Collateral Appraisal/pilihan dropdown bus'))
