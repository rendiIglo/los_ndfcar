...
WebUI.setText(findTestObject('TC.05_Funding_Preparation/Search By All Filed/Login/input_Username_UserName'), 'Yana')
...
not_run: WebUI.click(findTestObject('TC.05_Funding_Preparation/Search By All Filed/Page_Home Page - My ASPNET Application/ComboBox_Branch'))

not_run: WebUI.click(findTestObject('TC.05_Funding_Preparation/Search By All Filed/Page_Home Page - My ASPNET Application/Branch'))

not_run: WebUI.click(findTestObject('TC.05_Funding_Preparation/Search By All Filed/Page_Home Page - My ASPNET Application/Combobox_PlatForm'))

not_run: WebUI.click(findTestObject('TC.05_Funding_Preparation/Search By All Filed/Page_Home Page - My ASPNET Application/span_Sharia'))

not_run: WebUI.click(findTestObject('TC.05_Funding_Preparation/Page_Home Page - My ASPNET Application/search button'))

not_run: WebUI.click(findTestObject('Object Repository/TC.05_Funding_Preparation/TC.05/Page_Home Page - My ASPNET Application/div_Type a value'))

WebUI.setText(findTestObject('TC.05_Funding_Preparation/Search By All Filed/App Number'), '202005401LS00053')
...
WebUI.setText(findTestObject('TC.05_Funding_Preparation/Search By All Filed/Page_Home Page - My ASPNET Application/input_Aprv Date Start Text Box2'), 
    '28-Mei-2020')

WebUI.setText(findTestObject('TC.05_Funding_Preparation/Search By All Filed/Page_Home Page - My ASPNET Application/input_Aprv Date End Text Box2'), 
    '28-Mei-2020')
